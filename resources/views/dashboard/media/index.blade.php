                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-striped table-bordered table-hover" width="100%" border="0" cellspacing="0" cellpadding="0" summary="This is a list of the media.">
                                            <thead>
                                            <tr>
                                                <th>Image Name</th>
                                                <th>Description</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="edit" data-id="{{ $image->id }}">
                                                        ...
                                                        <button
                                                                ...
                                                                data-url="{!! URL::route('dashboard.images.destroy', $image->id) !!}"
                                                                data-toggle="modal"
                                                                data-target="#delete"
                                                                data-placement="top">
